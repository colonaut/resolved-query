...
const eql = (query_value, value, callback) => {

    console.log(value, '===', query_value);

    callback(null, query_value === value);
};
const lt = (query_value, value, callback) => {

    console.log(value, '<', query_value);

    callback(null, value < query_value);
};
const gt = (query_value, value, callback) => {

    console.log(value, '>', query_value);

    callback(null, value > query_value);
};
const lte = (query_value, value, callback) => {

    console.log(value, '<=', query_value);

    callback(null, value <= query_value);
};
const gte = (query_value, value, callback) => {
