...
const construct = (items, callback) => {
    ...
    items = items || [].concat(Privates.get(this).query_keys);
...
class ResolvedQuery {
     ...
     */
    isNumber(key) {
        return construct.bind(this).call((err, query_data) => !!query_data[key].is_number);
     ...
     */
    isArray(key) {
        return construct.bind(this).call((err, query_data) => !!query_data[key].is_array);
    }
    ...
    match(model, callback) {
        ...
        construct.bind(this).call((err, query_data) => {
     ...
     */
    value(key) {
        return construct.bind(this).call((err, query_data) => query_data[key].value);
    }
     ...
     */
    expr(key) {
        return construct.bind(this).call((err, query_data) => query_data[key].expression);
    };
