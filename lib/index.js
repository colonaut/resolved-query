...
const evalStringExpression = (query_value, value, callback) => {

    let pattern = query_value.replace(/\*/g, '\\D*')
        .replace(/\\D\*\\D\*\\D\*/g, '\\*\\D*')
        .replace(/\\D\*\\D\*/g, '\\*');
    ...
    //console.log('value:', value, 'pattern:', pattern, 'result:', regex.test(value));
